@section('script')
    <?php
        $furl = "js/Clients/Management/createManagement.js";
    ?>
                        ...
                        <div class="box-body">
                            <form id="frmDatos" class="form-horizontal" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="txtNombreCompleto" name="txtNombreCompleto" class="form-control validate"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2">Tel&eacute;fono</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="txtTelefono" name="txtTelefono" class="form-control validate"/>
                                    </div>
                                </div>
                            </form>
