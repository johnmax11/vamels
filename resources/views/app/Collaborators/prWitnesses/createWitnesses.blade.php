...
<div  id="card-panel" class="section card-panel">
    <h5 class="breadcrumbs-title">Registrar testigo</h5>
        ...
        <form id="frmDatos" class="col s12" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m3">
                    ...
                    <label for="txtSegundoApellido">Segundo apellidos</label>
                </div>
                <div class="input-field col s12 m3">
            ...
            <div class="row">
                <div class="input-field col s12 m3">
                    <select id="selCiudad" name="selCiudad" class="validate verify"></select>
                ...
                <div class="input-field col s12 m9">
                    ...
                    <label for="txtPuestoVotacion">Puesto votación</label>
                </div>
            </div>
        ...
        <div class="form-horizontal">
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button id="btnGuardar" type="submit" class="btn btn-custom blue">Guardar Informaci&oacute;n</button>
                </div>
            </div>
        </div>
    </div>
