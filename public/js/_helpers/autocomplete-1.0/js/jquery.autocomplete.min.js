...
! function(a) {
    ...
    b.utils = c, a.Autocomplete = b, b.formatResult = function(a, b) {
        ...
        processResponse: function(a, b, c) {
            if(a.msg == null || a.msg == undefined){
                alert("Error en respuesta autocomplete, Formato no esperado! (E-100)");
                return;
            }
            if(a.msg.rows == null || a.msg.rows == undefined){
                alert("Error en respuesta autocomplete, Formato no esperado! (E-101)");
                return;
            }
            a.suggestions = a.msg.rows;
            var d = this,
                e = d.options;
