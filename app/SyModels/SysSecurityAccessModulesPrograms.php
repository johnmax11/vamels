<?php
/**
 * Description of SecurityAccessModulesActions
 *
 * @author programador1
 */
namespace App\SyModels;
class SysSecurityAccessModulesPrograms extends \Eloquent {
    //put your code here
    /**
    ...
    * @var string
    */
    protected $table = 'sys_security_access_modules_programs';
